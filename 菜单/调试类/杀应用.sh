#!/system/bin/sh
# 批量停止用户与系统应用（带进度与间隔）
# 运行方式：adb shell sh /path/to/stop_apps.sh
...
echo "[系统] 正在停止: Android System Angle (com.android.angle)"
adb shell am force-stop com.android.angle
...
echo "[系统] 正在停止: Google Play services (com.google.android.gms)"
...
echo "[系统] 正在停止: Google Services Framework (com.google.android.gsf)"
...
# 'Themes'
echo "[系统] 正在停止: Themes (com.bbk.theme)"
adb shell am force-stop com.bbk.theme
...
# 'Original Vista'
echo "[系统] 正在停止: Original Vista (com.vivo.deformer)"
adb shell am force-stop com.vivo.deformer
...
# 'Security Center'
echo "[系统] 正在停止: Security Center (com.vivo.safecenter)"
adb shell am force-stop com.vivo.safecenter
...
# 'Phone Manager'
echo "[系统] 正在停止: Phone Manager (com.iqoo.secure)"
adb shell am force-stop com.iqoo.secure
...
# 'Drag & go'
echo "[系统] 正在停止: Drag & go (com.vivo.globaldragdrop)"
adb shell am force-stop com.vivo.globaldragdrop
...
# 'Sogou Keyboard Customized Version'
echo "[系统] 正在停止: Sogou Keyboard Customized Version (com.sohu.inputmethod.sogou.vivo)"
adb shell am force-stop com.sohu.inputmethod.sogou.vivo
...
# 'Baidu IME Customized Version'
echo "[系统] 正在停止: Baidu IME Customized Version (com.baidu.input_vivo)"
adb shell am force-stop com.baidu.input_vivo
...
# 'BlueLM Copilot kit'
echo "[系统] 正在停止: BlueLM Copilot kit (com.vivo.launchercopilot)"
adb shell am force-stop com.vivo.launchercopilot
...
# 'Settings'
echo "[系统] 正在停止: Settings (com.android.settings)"
...
# 'Super Pocket'
echo "[系统] 正在停止: Super Pocket (com.vivo.card)"
adb shell am force-stop com.vivo.card
